...
export class CursosService {
  ...
  current!: CourseInterface;
  constructor() { }



  getData(): Observable<CourseInterface[]> {
  ...
  getStudentById(id: number): Promise<CourseInterface | null> {
  ...
  addNewStudent(student: CourseInterface){
  ...
  saveEditedStudent(student: CourseInterface){
